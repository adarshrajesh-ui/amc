[![Discord](https://img.shields.io/badge/Discord-C%2FC%2B%2B%20%26%20HFT%20prep-5865F2?logo=discord&logoColor=white)](https://discord.gg/vx5Eu4YNzG)
...
> If you want one that's actually about the C/C++ / systems / low-latency side of this — debugging, interview problems, and where AI tooling helps (or lies to you) on systems code — I run one here: **[discord.gg/vx5Eu4YNzG](https://discord.gg/vx5Eu4YNzG)**.
> 
...
# Breaking into HFT as an SDE 2

> Coming from a product company? This is what changes. 

---

I get a lot of DMs from SDE 2s at product companies asking how to break into HFT. Short answer: you are probably preparing for the wrong things.

Big Tech SDE 2 means you can own a service end-to-end. HFT SDE 2 means you understand the machine at a molecular level. The overlap is smaller than you think.

I can not give out the exact resources but the issues I saw while talking to product guys and misalignment in their expectations. LLMs are still the best way to get exact information based on general guidelines.
 (If you go this route on C/C++, use a tool that reasons to the metal instead of guessing — I've been building **ByteAsk** for exactly this, and there's a community of people doing the same here: [discord.gg/vx5Eu4YNzG](https://discord.gg/vx5Eu4YNzG).)
 
## What Actually Gets Tested

- All topics you read above but with *WHY*.
- You can no longer treat above things as blackbox and get away with them.
- If for not all topics, pick depth for at least one of them and master it
- Best way is build project around this and question everything till you reach assembly (compute) or cache (memory). Reason till the end.
